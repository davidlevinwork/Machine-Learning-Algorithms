...
In the `PassiveAggressive.py` file you can find the implementation of the PA algorithm (and several other algorithms, in seperated classes). <br/>
The implemntation is for the Multi Class problem of Passive Aggressive algorithm.
...
> $ python PassiveAggressive.py <train_x_path> <train_y_path> <test_x_path> <output_file_name> <br/>
